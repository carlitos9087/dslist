...
A aplicação consiste em uma lista de games, onde os dados são armazenados em um banco SQL e retornado de acordo com
as requisições HTTP feitas, permitindo a categorização por gênero de jogo e também a alteração da ordem dos jogos 
exibidos na lista por meio de transações com o banco de dados.

## Estrutura do Projeto
O projeto segue o padrão de camadas arquiteturais, com a divisão em controllers, services e repositories, de modo a garantir a manutenção e expansão da aplicação.
